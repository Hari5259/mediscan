              ...
              {[
                ...
                <div key={i} className="p-8 border border-slate-50 bg-slate-50/50 rounded-[24px] group hover:bg-white hover:border-blue-200 hover:shadow-xl transition-all cursor-pointer">
                  ...
                  <div className="mt-6 flex gap-4 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button className="text-[11px] font-black uppercase tracking-widest text-blue-600 hover:underline">Verify Node</button>
                    <button className="text-[11px] font-black uppercase tracking-widest text-slate-400 hover:text-slate-900">Dismiss</button>
                  </div>
                </div>
              ))}
            </div>
